                ...
                <div id="panel-email" class="p-4 sm:p-6 lg:p-8 hidden">
                    <div class="max-w-xl mx-auto">
                        ...
                        <form action="{{ route('bettor.payment.contact') }}" method="POST" class="space-y-4">
                            ...
                            <button type="submit"
                                class="w-full bg-amber-500 hover:bg-blue-600 text-white font-bold py-3.5 px-4 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 shadow hover:shadow-md">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
