        ...
        <div class="flex justify-between items-center">
            ...
            @if($activeSubscription)
                <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm font-medium">
                    Active: {{ $activeSubscription->daysRemaining() }} days left
                </span>
            @endif
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow p-4 mb-6">
                <form action="{{ route('bettor.tips.premium') }}" method="GET" class="flex gap-4 flex-wrap">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse($tips as $tip)
                    <div class="bg-white rounded-lg shadow hover:shadow-lg transition overflow-hidden border-t-4 border-yellow-500">
                        <div class="p-6">
                            <!-- Match Info -->
                            <div class="mb-4">
                            ...
                            <div class="bg-yellow-50 rounded p-3 mb-4">
                                <p class="text-gray-800 font-medium">{{ Str::limit($tip->tip_content, 120) }}</p>
                            </div>
                ...
                @empty
                    <div class="col-span-full bg-white rounded-lg shadow p-12 text-center">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">No Premium Tips Available</h3>
                        <p class="mt-1 text-sm text-gray-500">Premium tips will appear here once posted by admin.</p>
                    </div>
                @endforelse
            </div>
